package com.giftvoucher.arwin.utils;
...
public class MyConstant {
    ...
    public static final String GETUSER = "/get/user/{email}";

    //admin
    public static final String CHECK_ADMIN = "/api/check/admin";
    ...
    public static final String GETPARTICULARGIFT = "/getpariculargift/{giftId}";
    ...
    public static final String GETORDER = "/get/order/{orderId}";
    public static final String GETUSERNAME = "/get/username/{email}";
    public static final String GETALLORDERS= "/get/orders";
    // public static final String GETALLORDERS = "/get/allOrders";
