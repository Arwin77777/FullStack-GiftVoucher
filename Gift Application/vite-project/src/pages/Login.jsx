...
function Login() {
  ...
  return (
    <MDBContainer fluid style={{width:'90%'}} className="p-3 my-5 h-custom">
      ...
      <MDBRow>
        ...
        <MDBCol col='4' md='6'>
          ...
          <div className='text-center text-md-start mt-4 pt-2'>
            <Link to="/home"> <MDBBtn className="mb-0 px-5" size='lg' style={{backgroundColor:'blue'}} onClick={handleFormSubmit}>Login</MDBBtn></Link>
