...
import { CDBBtn, CDBIframe, CDBProgress, CDBView } from "cdbreact";
import Sidebar from "../components/Sidebar"
import Navbar from "../components/Navbar";
import "./Profile.css"
import UserDp from "../images/profile.jpg"
...
export const Profile = () => {
	...
	<div style={{height:"100%"}}>
					<div style={{height:"calc(100% - 64px)", padding:"20px 2%", overflowY:"scroll"}}>
						<div style={{margin:"0 auto", maxWidth:"1320px"}}>
							<div  className="cards-container1">
								<div>
									<div className="card shadow border-0">
										<img alt="profileImage" src={UserDp} className="w-100" style={{objectFit:"cover", maxHeight:"300px",padding:'20px'}}/>
										<div className="card-body">
											<h4 className="card-title mb-2" style={{fontWeight:"600"}}>{name}</h4>
											<h5 className="mb-2">{email}</h5>
											<p className="text-justify mt-4">
												<strong className="mb-2">Desciption: </strong>
													This is the admin account for managing and knowing your statistics
											</p>
...
<div className="card shadow border-0">
					...
					<img alt="cardImg" className="img-fluid" style={{objectFit:"cover"}} src={rev}/>
					            <div className="p-3">
					              <h3>Revenue </h3>
								  <h4 style={{color:'black'}} className="my-4 text-right h2 font-weight-bold">₹2,00,000</h4>
					          ...
					          <div className="card shadow border-0 h-75 mx-auto" style={{backgroundImage:"url('https://cdn.pixabay.com/photo/2018/08/14/13/23/ocean-3605547_960_720.jpg')"}}>
					            <div className="p-3 d-flex flex-column h-100 w-100">
					              ...
					              <p style={{fontSize:'15px',margin:'10px'}} className="text-white">Elevate customer satisfaction with seamless product management, order handling, and insightful analytics on our Admin Profile Page. Drive success through efficient vendor relations, website customization, and robust security measures. Empower your e-commerce prowess and elevate user experience with our comprehensive admin tools</p>
			        ...
			        <footer className="d-flex mx-auto py-4">
			          <small className="mx-auto my-1 text-center">&copy; Earn well with our support</small>
			        </footer>
				    </div>
					</div>
				</div>
