...
import SalesHourly from "../components/SalesHourly";
	        ...
	        <div style={{height:"calc(100% - 64px)", overflowY:"scroll"}}>
	          <div className="d-flex card-section">
	              ...
	              <div className="card-bg w-100 border d-flex flex-column">
	                <div className="p-4 d-flex flex-column h-100">
	                  <div className="d-flex align-items-center justify-content-between">
	                    <h4 className="m-0 h5 font-weight-bold text-dark">Reviews By Customers</h4>
	              ...
	              <div className="card-bg w-100 border d-flex flex-column p-4" style={{gridRow:"span 2"}}>
	                <div className="d-flex">
	                  <h6  className="h5 font-weight-bold text-dark">Orders</h6>
	                  <div className="ml-auto rounded-circle bg-grey py-1 px-2"><i className="fas fa-order"></i></div>
	                </div>
					 
	                <div className="d-flex mt-4">
	                  {/* <img alt="panelImage" src="img/pane/pane1.png" className="pane-image" size="md"/> */}
	                  <div>
	                    <h6 className="mb-0" style={{fontWeight:"600"}}></h6>
	                    <p className="m-0" style={{fontSize:"0.75em"}}></p>
	                  </div>         
